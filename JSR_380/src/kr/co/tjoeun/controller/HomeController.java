...
public class HomeController {
	...
	public String home() {
		System.out.println("주소표시줄에 http://localhost:8080/JSR-380/ 이 입력되었습니다");
	...
	public String tjoeun() {
		System.out.println("주소표시줄에 http://localhost:8080/JSR-380/tjoeun 이 입력되었습니다");
		return null;
	}
	
	@RequestMapping(value="/spring", method=RequestMethod.GET)
	public String spring() {
		System.out.println("주소표시줄에 http://localhost:8080/JSR-380/spring 이 입력되었습니다");
		return null;
	}
