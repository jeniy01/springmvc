...
<body>
	...
	같은 값은 value로 하는 항목이 선택된 상태로 태그가 생성됨
	 -->
	<h2>test1.jsp</h2>
	<form:form modelAttribute="beanData" action="result">
		...
		<form:select path="data4">
			<form:options items="${requestScope.dataList2 }" itemLable="key" itemValue="value" />
		</form:select>
		<hr>
		...
		<hr>
		<form:checkbox path="data9" value="C언어과정" />C언어과정
		<form:checkbox path="data9" value="JSP과정" />JSP과정
		<form:checkbox path="data9" value="JSP과정" />자바웹개발과정
		<form:checkbox path="data9" value="Spring과정" />Spring과정
		<hr>
