...
public class TestController {
	...
	@GetMapping("/test2")
	public String test2Get(@RequestParam Map<String, String> map, @RequestParam List<String> numbers) {
	...
	@GetMapping("/test3")
	public String test3Get(@RequestParam Map<String, String> map, @RequestParam List<String> numbers) {
		String strNum1 = map.get("num1");
		String strNum2 = map.get("num2");
		String numberMap = map.get("numbers");
	...
	@GetMapping("/test4")
	public String test4Get(@ModelAttribute BeansData bean1, @ModelAttribute BeansData2 bean2, @ModelAttribute BeansData3 bean3) {
