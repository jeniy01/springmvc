...
public class TestController {
	...
	public String test1(HttpServletRequest request) {
		...
		//setAttribute: data를 requestScope라는 메모리 영역에 올림
	...
	public String result1(HttpServletRequest request) {
		...
		//getAttribute: data를 requestScope라는 메모리 영역에서 가져옴
	...
	public String test2(Model model) {
		/*
		model.addAttribute을 사용해서 data를 메모리에 올리면
		HttpServletRequest 객체에 저장됨(request scope에 저장됨)
		*/
	...
	public ModelAndView test3(ModelAndView mv) {
		//ModelAndView 객체를 사용해서 data를 메모리에 올리면 requestScope 영역에서 HttpServletRequest 객체에 저장됨
