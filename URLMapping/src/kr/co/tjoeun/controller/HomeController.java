...
public class HomeController {
	...
	public String home() {
		System.out.println("주소표시줄에 http://localhost:8080/URLMapping/ 이 입력되었습니다");
	...
	public String tjoeun() {
		System.out.println("주소표시줄에 http://localhost:8080/URLMapping/tjoeun 이 입력되었습니다");
		return null;
	}
	
	@RequestMapping(value="/spring", method=RequestMethod.GET)
	public String spring() {
		System.out.println("주소표시줄에 http://localhost:8080/URLMapping/spring 이 입력되었습니다");
		return null;
	}
