...
public class HomeController {
	...
	public String tjoeun() {
		System.out.println("주소표시줄에 http://localhost:8080/boardproject4/tjoeun 이 입력되었습니다.");
		return null;
	}
	
	@RequestMapping(value="/spring", method=RequestMethod.GET)
	public String spring() {
		System.out.println("주소표시줄에 http://localhost:8080/boardproject4/spring 이 입력되었습니다.");
		return null;
	}
}