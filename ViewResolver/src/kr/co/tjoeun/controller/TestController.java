...
public class TestController {
	...
	test1.jsp에서 EL로 이 변수값을 받을 수 있음
	...
	*/
	...
	/*
	내장객체인 HttpServletRequest을 사용해서 data를 메모리에 올릴 수 있음
	setAttribute() 메서드를 사용해서 메모리에 올라간 data를 test2.jsp에서
